...
tar -xvf trancos_ccnn.caffemodel.tar.gz
...
tar -xvf trancos_hydra2.caffemodel.tar.gz
...
tar -xvf trancos_hydra3.caffemodel.tar.gz
...
tar -xvf trancos_hydra4.caffemodel.tar.gz
