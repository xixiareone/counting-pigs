...
# CAFFE_MODEL=/media/tmx/Gin/counting/googlenet/model/ccnn_trancos_iter_50000.caffemodel
# CAFFE_MODEL=genfiles/output_models/trancos/ccnn/ccnn_trancos_iter_50000.caffemodel
# CAFFE_MODEL = /media/tmx/Gin/counting/datasets/withoutaugmentation/model/ccnn_trancos_iter_50000.caffemodel
...
LOG="experiments/2018_7_logs/trancos_ccnn_`date +'%Y-%m-%d_%H-%M-%S'`.txt"
exec &> >(tee -a "$LOG")
...
# Train Net
caffe train -solver ${SOLVER} --weights models/pretrained_models/trancos/ccnn/trancos_ccnn.caffemodel
